...
namespace librbd {
  ...
  struct ImageCtx {
    ...
    long long bps_write_limit; //shiqi add
    long long bps_read_limit;
	long long iops_write_limit;
	long long iops_read_limit;
	long long bucket; 
	//long long bucket_max;
	long long bps_bucket_rd_max;
	long long bps_bucket_wr_max;
	//long long iops_bucket_max;
	long long iops_bucket_rd_max;
	long long iops_bucket_wr_max;
	//
	long last_time;
	long read_last_time;
	long iops_read_last_time;
	long iops_write_last_time;
	long long rdbucket;
	long long iops_rdbucket;
	long long iops_rwbucket;
	pthread_mutex_t rdlock;
	pthread_mutex_t wtlock;
	uint64_t watch_hanle;
	//new add
	long long bps_total_limit;
	long long iops_total_limit;
	long long total_iops_bucket;
	long long total_bps_bucket;
	long long total_iops_bucket_max;
	long long total_bps_bucket_max;
	long total_iops_lasttime;
	long total_bps_lasttime;
	//new add
    /**
     * Lock ordering:
     *
